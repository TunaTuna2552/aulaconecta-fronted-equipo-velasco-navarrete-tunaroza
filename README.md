...
# DESCRIPCIÓN
El proyecto consiste en un aplicativo web que agilice el proceso
...
1. **Sin errores en consola**: No debe generar errores o alertas en el navegador.
2. **Código limpio y legible**: Debe seguir una estructura clara, estar correctamente indentado y no incluir código innecesario.
3. **Diseño Responsivo**: Comprobar que la vista funcione correctamente tanto en dispositivos móviles como en computadoras de escritorio.
4. **Revisión y Aprobación**: Tener al menos una aprobación en el Pull Request por parte de un compañero del equipo.
5. **Funcionalidad probada**: La nueva característica debe cumplir al 100% con la tarea asignada sin romper otras secciones existentes.

# Fuentes consultadas
* Documentación oficial de React: (https://react.dev)
* Mozilla Developer Network (MDN Web Docs): (https://developer.mozilla.org)
* Documentación de Git y GitHub: (https://docs.github.com)
